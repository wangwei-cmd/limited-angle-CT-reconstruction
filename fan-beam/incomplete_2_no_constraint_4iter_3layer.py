...
if __name__ == '__main__':
    ...
    udir = "./limited_angle/"
    vdir = "validate"
    train(epoch, udir, batch, theta, iternum, restore=0, ckpt='./512x512/limited-angles/weights/fanbeam/incomplete_2_no_constraint_4iter_3layer')